...
BEGIN
	INSERT INTO USER 
	(USER_ID, USER_NAME, USER_EMAIL, USER_PASSWORD, IMG_URL, USER_TYPE_ID) 
	VALUES (UUID(), V_USER_NAME, V_USER_EMAIL, V_USER_PASSWORD, V_IMG_URL, '89a9c26a-100b-11f0-ab2e-020017000d59');
END
...
BEGIN
	INSERT INTO USER 
	(USER_ID, USER_NAME, USER_EMAIL, USER_PASSWORD, IMG_URL, USER_TYPE_ID) 
	VALUES (UUID(), V_COMPANY_NAME, V_COMPANY_EMAIL, V_COMPANY_PASSWORD, V_IMG_URL, '8986b070-100b-11f0-ab2e-020017000d59');
END
