...
CREATE PROCEDURE INSERT_COMPANY (IN V_COMPANY_NAME VARCHAR(255), IN V_USER_LOGIN VARCHAR(20), IN V_COMPANY_EMAIL VARCHAR(255), IN V_COMPANY_PASSWORD VARCHAR(255), IN V_IMG_URL VARCHAR(255))
BEGIN
	INSERT INTO USER 
	(USER_ID, USER_NAME, USER_LOGIN, USER_EMAIL, USER_PASSWORD, IMG_URL, USER_TYPE_ID) 
	VALUES (UUID(), V_COMPANY_NAME,  V_USER_LOGIN, V_COMPANY_EMAIL, V_COMPANY_PASSWORD, V_IMG_URL, '8986b070-100b-11f0-ab2e-020017000d59');
END
