...
WHERE t.TAG_NAME = 'TESTE_2';


SELECT * FROM TAG t ;
SELECT * FROM TAG_COMPANY tc ;
SELECT * FROM COMPANY c ;
SELECT * FROM PRODUCT p WHERE p.PRODUCT_VIEW_QTY IS NULL;

CALL INSERT_TAG ('TESTE PROCEDURE','a6059147-11a3-11f0-ab2e-020017000d59');
