...
<div class="produto-completo-container">
    ...
    <div class="produto-imagens-container">
        ...
        <div class="imagem-principal">
            <img src="<?= htmlspecialchars($product['IMG_URL']) ?>" alt="<?= htmlspecialchars($product['PRODUCT_NAME']) ?>" class="imagem-principal-img">
        </div>
            ...
            <div class="comentarios-carrossel">
                <?php foreach ($comments as $comment): ?>
                    <div class="comentario-item">
                        ...
                        <footer>- <?= htmlspecialchars($comment['USER_NAME']) ?>, em <?= date('d/m/Y', strtotime($comment['CREATED_AT'])) ?></footer>
                    </div>
                <?php endforeach; ?>
            </div>
        <?php else: ?>
