...
ALTER TABLE POST MODIFY COLUMN SUBTITLE VARCHAR(255) AFTER TITLE;
...
SELECT * FROM COMMENT c WHERE c.USER_ID  = 'a60585b7-11a3-11f0-ab2e-020017000d59';

UPDATE COMMENT c SET USER_ID = '8c6b8fea-119d-11f0-ab2e-020017000d59';

SELECT * FROM `USER` u WHERE u.USER_ID  = 'a60585b7-11a3-11f0-ab2e-020017000d59';
