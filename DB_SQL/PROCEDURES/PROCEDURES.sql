...
BEGIN
	SELECT p.POST_CONTENT, u.USER_NAME 
	FROM POST p
...
CREATE PROCEDURE INSERT_COMPANY (IN V_COMPANY_NAME VARCHAR(255), IN V_COMPANY_EMAIL VARCHAR(255), IN V_IMG_URL VARCHAR(255))
BEGIN
	INSERT INTO USER 
	(USER_ID, USER_NAME, USER_EMAIL, USER_PASSWORD, IMG_URL) 
