...
CREATE TABLE DB_INCEPTUS_PP.USER (
	...
	USER_TYPE_ID BINARY(36) NOT NULL,
	IMG_URL VARCHAR(100),
	CREATED_AT DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
	UPDATED_AT DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,	
	...
	CONSTRAINT USER_LOGIN_UK UNIQUE KEY (USER_LOGIN),
	CONSTRAINT USER_TYPE_ID_FK FOREIGN KEY (TYPE_ID) REFERENCES DB_INCEPTUS_PP.USER_TYPE(TYPE_ID)
)
ENGINE=InnoDB
DEFAULT CHARSET=utf8mb4
COLLATE=utf8mb4_0900_ai_ci
...
CREATE TABLE DB_INCEPTUS_PP.COMPANY (
	...
	CONSTRAINT USER_ID_FK FOREIGN KEY (USER_ID) REFERENCES DB_INCEPTUS_PP.USER(USER_ID)
)
ENGINE=InnoDB
DEFAULT CHARSET=utf8mb4
COLLATE=utf8mb4_0900_ai_ci
...
CREATE TABLE DB_INCEPTUS_PP.ADDRESS (
	...
	CONSTRAINT ADDRESS_COMPANY_ID_FK FOREIGN KEY (COMPANY_ID) REFERENCES DB_INCEPTUS_PP.COMPANY(COMPANY_ID) ,
...
CREATE TABLE DB_INCEPTUS_PP.PRODUCT (
	...
	CONSTRAINT PRODUCT_CATEGORY_ID_FK FOREIGN KEY (CATEGORY_ID) REFERENCES DB_INCEPTUS_PP.CATEGORY(CATEGORY_ID) ,
	CONSTRAINT PRODUCT_COMPANY_ID_FK FOREIGN KEY (COMPANY_ID) REFERENCES DB_INCEPTUS_PP.COMPANY(COMPANY_ID) 
)
ENGINE=InnoDB
DEFAULT CHARSET=utf8mb4
COLLATE=utf8mb4_0900_ai_ci
...
CREATE TABLE DB_INCEPTUS_PP.COMMENT (
	...
	CONSTRAINT COMMENT_USER_ID_FK FOREIGN KEY (USER_ID) REFERENCES DB_INCEPTUS_PP.USER(USER_ID) ,
	CONSTRAINT COMMENT_COMPANY_ID_FK FOREIGN KEY (COMPANY_ID) REFERENCES DB_INCEPTUS_PP.COMPANY(COMPANY_ID) ,
	CONSTRAINT COMMENT_PRODUCT_ID_FK FOREIGN KEY (PRODUCT_ID) REFERENCES DB_INCEPTUS_PP.PRODUCT(PRODUCT_ID) 
)
ENGINE=InnoDB
DEFAULT CHARSET=utf8mb4
COLLATE=utf8mb4_0900_ai_ci
...
CREATE TABLE DB_INCEPTUS_PP.COMMENT_EXT (
	...
	CONSTRAINT COMMENT_EXT_COMMENT_ID_FK FOREIGN KEY (COMMENT_ID) REFERENCES DB_INCEPTUS_PP.COMMENT(COMMENT_ID),
	CONSTRAINT COMMENT_EXT_USER_ID_FK FOREIGN KEY (USER_ID) REFERENCES DB_INCEPTUS_PP.COMMENT(USER_ID) 
)
ENGINE=InnoDB
DEFAULT CHARSET=utf8mb4
COLLATE=utf8mb4_0900_ai_ci
...
CREATE TABLE POST (
	...
	CONSTRAINT POST_STATUS_CK CHECK (POST_STATUS = 'A' OR POST_STATUS = 'I'),
  	CONSTRAINT POST_COMPANY_ID_FK FOREIGN KEY (COMPANY_ID) REFERENCES DB_INCEPTUS_PP.COMPANY (COMPANY_ID) 
) 
...
CREATE TABLE POST_EXT (
  	...
  	CONSTRAINT POST_EXT_POST_ID_FK FOREIGN KEY (POST_ID) REFERENCES DB_INCEPTUS_PP.POST (POST_ID),
  	CONSTRAINT POST_EXT_USER_ID_FK FOREIGN KEY (USER_ID) REFERENCES DB_INCEPTUS_PP.USER (USER_ID) 
) 
ENGINE=InnoDB DEFAULT 
CHARSET=utf8mb4 
COLLATE=utf8mb4_0900_ai_ci
...
CREATE TABLE TAG_COMPANY (
  	...
  	CONSTRAINT TAG_COMPANY_TAG_ID_FK FOREIGN KEY (TAG_ID) REFERENCES DB_INCEPTUS_PP.TAG (TAG_ID) ,
  	CONSTRAINT TAG_COMPANY_COMPANY_ID_FK FOREIGN KEY (COMPANY_ID) REFERENCES DB_INCEPTUS_PP.COMPANY(COMPANY_ID) 
) 
ENGINE=InnoDB DEFAULT 
CHARSET=utf8mb4 
COLLATE=utf8mb4_0900_ai_ci
...
CREATE TABLE TAG_PRODUCT (
 	...
 	CONSTRAINT TAG_PRODUCT_TAG_ID_FK FOREIGN KEY (TAG_ID) REFERENCES DB_INCEPTUS_PP.TAG(TAG_ID) ,
  	CONSTRAINT TAG_PRODUCT_PRODCUT_ID_FK FOREIGN KEY (PRODUCT_ID) REFERENCES DB_INCEPTUS_PP.PRODUCT(PRODUCT_ID) 
) 
ENGINE=InnoDB DEFAULT 
CHARSET=utf8mb4 
COLLATE=utf8mb4_0900_ai_ci
...
CREATE TABLE SEC_RST_CODE (
 	...
 	USER_ID BINARY(36),
  	...
  	CONSTRAINT SEC_RST_CODE_ID_USER_ID_FK FOREIGN KEY (USER_ID) REFERENCES DB_INCEPTUS_PP.USER(USER_ID) 
) 
ENGINE=InnoDB DEFAULT 
CHARSET=utf8mb4 
COLLATE=utf8mb4_0900_ai_ci
...
CREATE TABLE ADMIN_POST (
	...
	CONSTRAINT ADM_POST_STATUS_CK CHECK (ADM_POST_STATUS = 'A' OR ADM_POST_STATUS = 'I')
  	CONSTRAINT ADMIN_POST_USER_ID_FK FOREIGN KEY (USER_ID) REFERENCES DB_INCEPTUS_PP.USER(USER_ID) ,
  	CONSTRAINT ADMIN_POST_COMPANY_ID_FK FOREIGN KEY (COMPANY_ID) REFERENCES DB_INCEPTUS_PP.COMPANY (COMPANY_ID) 
) 
ENGINE=InnoDB DEFAULT 
CHARSET=utf8mb4 
COLLATE=utf8mb4_0900_ai_ci
...
CREATE TABLE PROD_UDA (
  	...
  	CONSTRAINT PROD_UDA_UDA_ID_FK FOREIGN KEY (UDA_ID) REFERENCES DB_INCEPTUS_PP.UDA (UDA_ID) ,
  	CONSTRAINT PROD_UDA_PRODUCT_ID_FK FOREIGN KEY (PRODUCT_ID) REFERENCES DB_INCEPTUS_PP.PRODUCT (PRODUCT_ID) 
) 
ENGINE=InnoDB DEFAULT 
CHARSET=utf8mb4 
COLLATE=utf8mb4_0900_ai_ci
...
CREATE TABLE COMP_UDA (
  	...
  	CONSTRAINT COMP_UDA_UDA_ID_FK FOREIGN KEY (UDA_ID) REFERENCES DB_INCEPTUS_PP.UDA (UDA_ID) ,
  	CONSTRAINT COMP_UDA_COMPANY_ID_FK FOREIGN KEY (COMPANY_ID) REFERENCES DB_INCEPTUS_PP.COMPANY(COMPANY_ID) 
) 
ENGINE=InnoDB DEFAULT 
CHARSET=utf8mb4 
COLLATE=utf8mb4_0900_ai_ci
