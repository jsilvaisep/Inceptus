...
BEGIN
	SELECT * FROM COMPANY C WHERE COMPANY_STATUS = 'A' ORDER BY C.COMPANY_RANK DESC LIMIT 3;
END

CREATE PROCEDURE PRODUCT_TOP()
BEGIN
	SELECT P.PRODUCT_NAME, P.PRODUCT_DESCRIPTION, P.IMG_URL
	FROM PRODUCT P WHERE P.PRODUCT_STATUS = 'A' ORDER BY P.PRODUCT_RANK DESC LIMIT 3;
END
