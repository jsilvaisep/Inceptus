...
CREATE PROCEDURE INSERT_PRODUCT (IN V_PRODUCT_NAME VARCHAR(255), IN V_PRODUCT_DESCRIPTION VARCHAR(1000), IN V_CATEGORY_ID VARCHAR(255), IN V_COMPANY_ID VARCHAR(255), IN V_IMG_URL VARCHAR(255))
BEGIN
...
CREATE PROCEDURE INSERT_POST (IN V_COMPANY_ID BINARY(36), IN V_TITLE VARCHAR(255), IN V_SUBTITLE VARCHAR(255), IN V_POST_CONTENT VARCHAR(2000))
BEGIN
	INSERT INTO POST (POST_ID, COMPANY_ID, TITLE, SUBTITLE, POST_CONTENT)
	VALUES(UUID(), V_COMPANY_ID, V_TITLE, V_SUBTITLE, V_POST_CONTENT);
END;
-- --------------------------------------------------------------------------------------------
